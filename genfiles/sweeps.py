...
files  = glob.glob('/global/project/projectdirs/cosmo/data/legacysurvey/dr8/south/sweep/8.0/*.fits')
...
for i, _file in enumerate(files):
  ...
  dat.write('/global/cscratch1/sd/mjwilson/BGS/SV-ASSIGN/sweeps/sweep-{}-vadd.fits'.format(name), format='fits', overwrite=True)
