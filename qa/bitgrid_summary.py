...
##
files            = glob.glob('bitgrid/txt/tile_*.txt')
skies            = glob.glob('bitgrid/txt/sky_tile_*.txt')
...
legend['Comment'][1]  =  'Standard - Faint.'
...
legend['Comment'][30] = r'GAIA stellarity color cut.'
legend['Comment'][31] = r'GAIA G of zero.'
legend['Comment'][32] = r'PSF morphology'
legend['Comment'][33] = r'Bad column, bright pixel etc.'
legend['Comment'][34] = r'Saturated'
legend['Comment'][35] = r'Bleed trail.'
legend['Comment'][36] = r'Edge pixel.'
legend['Comment'][37] = r'{\tt legacypipe} outlier pixel.'
...
with open('bitgrid/tex/legend.tex', 'w') as tt:
  tt.write(lines[0])
  tt.write('\n')
  tt.write(lines[1])
  tt.write('\n')
