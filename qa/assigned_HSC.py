...
legacyn    = Table(fits.open('/global/cscratch1/sd/mjwilson/BGS/SV-ASSIGN/truth/legacy/ls-hsc_pdr1_deep.forced.reduced-north.fits')[1].data)
legacys    = Table(fits.open('/global/cscratch1/sd/mjwilson/BGS/SV-ASSIGN/truth/legacy/ls-hsc_pdr1_deep.forced.reduced-south.fits')[1].data)
